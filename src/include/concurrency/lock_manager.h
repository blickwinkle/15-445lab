...
class LockManager {
 ...
 private:
  ...
  void BookNewTableLockInfoTxn(Transaction *txn, LockMode lock_mode, const table_oid_t &oid);
  void BookDelTableLockInfoTxn(Transaction *txn, LockMode lock_mode, const table_oid_t &oid);
  void BookNewRowLockInfoTxn(Transaction *txn, LockMode lock_mode, const table_oid_t &oid, const RID &rid);
  void BookDelRowLockInfoTxn(Transaction *txn, LockMode lock_mode, const table_oid_t &oid, const RID &rid);
  
  void UpdateTxnStateByUnlock(Transaction *txn, LockMode lock_mode);
